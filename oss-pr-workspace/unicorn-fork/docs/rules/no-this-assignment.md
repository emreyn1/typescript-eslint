...
- [`@typescript-eslint/no-this-alias`](https://typescript-eslint.io/rules/no-this-alias/) - Similar rule from typescript-eslint. If you use both plugins, you only need one of these rules. The typescript-eslint version has an `allowDestructuring` option.
