...
export const metadata: Metadata = {
  title: "Verify Email | MovieOn",
  description: "Check your email for the magic link to sign in to MovieOn",
  keywords: ["MovieOn", "Verify Email", "Magic Link", "Authentication"],
  openGraph: {
    type: "website",
    url: "https://movieon.com/login/verify",
    title: "Verify Email | MovieOn",
    description: "Check your email for the magic link to sign in to MovieOn",
    images: [
      {
        url: "https://movieon.com/og.webp",
        alt: "Verify Email | MovieOn",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    site: "https://movieon.com/login/verify",
    title: "Verify Email | MovieOn",
    description: "Check your email for the magic link to sign in to MovieOn",
    images: [
      {
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center space-y-4">
            ...
            <div>
              <h1 className="text-3xl font-light text-foreground">
                <span className="font-medium">MovieOn</span>
              </h1>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground font-light">
              Having trouble?{" "}
              <Link
                href="https://github.com/Nyumat/MovieOn"
                target="_blank"
