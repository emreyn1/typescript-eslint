...
export const metadata = {
  title: "Privacy Policy - MovieOn",
  description: "Privacy Policy for MovieOn streaming platform",
};
          ...
          <LegalPage title="Privacy Policy">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                <strong>No Account Required:</strong> MovieOn does not
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Since MovieOn has no user accounts or registration system, we
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                MovieOn integrates with several external services:
              </p>
              ...
              <div className="mb-6">
                ...
                <p className="text-muted-foreground leading-relaxed mt-2">
                  <strong>Important:</strong> MovieOn is not responsible for
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Since MovieOn doesn't require accounts or collect personal
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                MovieOn itself is completely ad-free. However, when you visit
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Since MovieOn doesn't collect personal information from
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                github.com/nyumat/movieon. As an open-source project, we're
