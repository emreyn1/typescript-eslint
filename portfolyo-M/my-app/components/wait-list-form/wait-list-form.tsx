  ...
  const ThankYouMessage = (
    ...
    >
      <div className="flex flex-col items-center justify-center text-center">
        <h1 className="text-4xl font-medium bg-linear-to-b from-[#00000030] to-black bg-clip-text text-transparent">
      ...
      >
        <h1 className="text-4xl font-medium bg-linear-to-b from-[#00000030] to-black bg-clip-text text-transparent">
          ...
          <span
            ...
            } bg-linear-to-r from-[#ff9292] to-[#ff0000] bg-clip-text text-transparent`}
          >
            HextaUI
          </span>
        </h1>
