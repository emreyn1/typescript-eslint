...
// Özel CSS kullanıyorsanız, ekleyin:
...
export const Component = () => {
  ...
  return (
    <div ref={containerRef} className="relative w-full">
      <canvas ref={canvasRef} style={{ position: 'absolute', zIndex: 0, top: 0, left: 0, width: '100%', height: '100%' }} />
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white">
        {/* Side menu */}
        <div ref={menuRef} className="absolute top-0 left-0 p-4">
          <div className="menu-icon flex flex-col gap-1">
            <span className="w-6 h-1 bg-white"></span>
            <span className="w-6 h-1 bg-white"></span>
            <span className="w-6 h-1 bg-white"></span>
          </div>
          <div className="mt-4 text-xl font-semibold transform -rotate-90 origin-left">SPACE</div>
        </div>
        ...
        <div className="hero-content text-center">
          ...
          <div ref={subtitleRef} className="mt-4 text-lg">
        ...
        {/* Scroll progress */}
        <div ref={scrollProgressRef} className="absolute bottom-4 right-4 text-center">
          <div className="scroll-text text-sm">SCROLL</div>
          <div className="progress-track w-24 h-1 bg-gray-500 mt-2">
            <div className="progress-fill h-full bg-white" style={{ width: `${scrollProgress * 100}%` }} />
          </div>
          <div className="section-counter mt-2 text-sm">
            {String(currentSection).padStart(2, '0')} / {String(totalSections).padStart(2, '0')}
          </div>
        </div>

        {/* Scroll sections */}
        <div className="scroll-sections flex flex-col items-center">
          {[...Array(2)].map((_, i) => (
            <section key={i} className="content-section py-10 text-center">
              <h1 className="text-5xl font-bold">{splitTitle(titles[i + 1] || 'DEFAULT')}</h1>
