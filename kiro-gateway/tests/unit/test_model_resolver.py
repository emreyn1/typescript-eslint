...
class TestGetModelIdForKiro:
    ...
    def test_resolves_alias_before_normalization(self):
        """MODEL_ALIASES are resolved before normalizing the model name."""
    ...
    def test_alias_resolution_then_normalization(self):
        """Alias resolves first, then normalization runs on the result."""
        from unittest.mock import patch
    ...
    def test_alias_to_hidden_model(self):
        """Alias can point at a hidden model and resolve to its internal ID."""
        from unittest.mock import patch
    ...
    def test_non_aliased_model_unchanged(self):
        """Models without an alias still resolve normally."""
        from unittest.mock import patch
    ...
    def test_empty_aliases_dict(self):
        """Empty MODEL_ALIASES leaves resolution unchanged."""
        from unittest.mock import patch
